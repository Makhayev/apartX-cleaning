...
const RoomSelector: React.FC = () => {
  ...
  return (
    <div className="flex h-8 items-center justify-center gap-2 rounded bg-white text-white">
      <button
        className="h-8 w-8 cursor-pointer rounded-l border-none bg-[#1195FF] outline-none hover:bg-[#1195FF]/80"
      ...
      <button
        className="h-8 w-8 cursor-pointer rounded-r border-none bg-[#1195FF] outline-none hover:bg-[#1195FF]/80"
        onClick={() => setRooms((rooms) => rooms + 1)}
        disabled={rooms === 5}
      >
        +
  ...
  >
    ...
    <main className="flex h-screen flex-col justify-start">
      ...
      <div className="flex flex-col  items-center justify-center gap-4 px-32">
        ...
        <h2 className="mb-12 font-bold text-[#555555]">WHAT WE ARE OFFERING</h2>
        <div className="flex gap-4">
          <Offer
            name="House Cleaning"
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <h2 className="mb-2 font-bold text-[#555555]">RECENT WORK SHOWCASE</h2>
        <PortfolioSlider />
      </div>
